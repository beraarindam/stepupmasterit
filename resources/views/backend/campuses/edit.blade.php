                    ...
                    <div>
                        <div class="mb-4">
                            ...
                            <textarea name="description" rows="9"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary outline-none editor">{{ old('description', $campus->description) }}</textarea>
                        </div>
                        <div class="mb-4">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <textarea name="tab_overview" rows="5"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary outline-none editor">{{ old('tab_overview', $campus->tab_overview) }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Tab 2: Descriptions</label>
                            <textarea name="tab_descriptions" rows="5"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary outline-none editor">{{ old('tab_descriptions', $campus->tab_descriptions) }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Tab 3: Career</label>
                            <textarea name="tab_career" rows="5"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary outline-none editor">{{ old('tab_career', $campus->tab_career) }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Tab 4: Summary</label>
                            <textarea name="tab_summary" rows="5"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary outline-none editor">{{ old('tab_summary', $campus->tab_summary) }}</textarea>
                        </div>
                    </div>
                </div>
