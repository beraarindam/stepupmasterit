...
@section('breadcrumb', 'Admin / Course Categories / Edit')
@section('content')
    <div class="space-y-6 animate-fade-in-up">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Edit Category 📚</h2>
                <p class="text-gray-500 mt-1">Update the details of the course category.</p>
            </div>
            <div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <form action="{{ route('admin.course-categories.update', $category->id) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
