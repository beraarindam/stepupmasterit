...
@section('content')
    <div class="space-y-6 animate-fade-in-up">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Edit Branch ✏️</h2>
                <p class="text-gray-500 mt-1">Update details for: {{ $branch->name }}</p>
            </div>
            <div>
                    ...
                    <div>
                        <div class="mb-4">
                            ...
                            <textarea name="opening_hours" rows="4"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary outline-none"
                                placeholder="Mon - Fri: 9:00 AM - 6:00 PM">{{ old('opening_hours', $branch->opening_hours) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="map_embed" rows="4"
                                ...
                                placeholder="https://www.google.com/maps/embed?pb=...">{{ old('map_embed', $branch->map_embed) }}</textarea>
                            <p class="text-xs text-gray-500 mt-1">Paste the embed URL from Google Maps (Share → Embed map)</p>
                        </div>
                    </div>
                </div>
