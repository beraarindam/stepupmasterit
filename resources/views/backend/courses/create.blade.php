    ...
    <div class="space-y-6 animate-fade-in-up">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-500 mt-1">Provide course details like duration, fee, and description.</p>
            </div>
            <div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <form action="{{ route('admin.courses.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Course Category <span
                        ...
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Course Title <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" name="duration" value="{{ old('duration') }}" placeholder="e.g. 6 Months"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary outline-none">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Course Fee</label>
                                <input type="text" name="fee" value="{{ old('fee') }}" placeholder="e.g. $499 or Free"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary outline-none">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="short_description" rows="5"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary outline-none editor">{{ old('short_description') }}</textarea>
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Course Thumbnail / Image <span
                                    class="text-red-500">*</span></label>
                            <div
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <p class="text-xs text-gray-500">PNG, JPG, GIF up to 2MB. Recommended size: 800x600px.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                @include('backend.courses.partials.learning_outcomes', ['items' => old('learning_outcomes', [''])])
