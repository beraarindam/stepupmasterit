...
@section('content')
    <div class="space-y-6 animate-fade-in-up">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Edit Course ✏️</h2>
                <p class="text-gray-500 mt-1">Update details for: {{ $course->title }}</p>
            </div>
            <div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="fee" value="{{ old('fee', $course->fee) }}"
                    ...
                    <div>
                        <div class="mb-4">
                            ...
                            <textarea name="description" rows="9"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary outline-none">{{ old('description', $course->description) }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @if($course->image)
                                <div class="mb-4 relative group inline-block">
                                    <img src="{{ asset($course->image) }}" alt="Current Image"
                            ...
                            <div
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <p class="text-xs text-gray-500 text-center mt-2">Leave blank to keep current image.
                                        PNG, JPG, GIF up to 2MB.</p>
                                </div>
                            </div>
                        </div>
                    </div>
