...
<head>
    ...
    <title>@yield('meta_title', get_setting('site_title')) | @yield('title', 'Welcome')</title>
    <meta name="description" content="@yield('meta_description', get_setting('site_description'))">
    <meta name="keywords" content="@yield('meta_keywords', get_setting('site_keywords'))">
